...
| `/rakkas.config.[jt]s` | Rakkas [configuration file](./configuration-options)                       |
| `/public`              | [Static files](./static-files) to be served from `/`                       |
| `/src/client.[jt]s`    | [Client-side customization hooks](./customization-hooks#server-side)       |
| `/src/server.[jt]s`    | [Server-side customization hooks](./customization-hooks#client-side)       |
